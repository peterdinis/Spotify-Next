...
const HomeIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height={size}
...
const SearchIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height={size}
...
const LibIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height={size}
...
const ActiveHomeIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height={size}
...
const ActiveSearchIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="24"
...
const ActiveCollectionIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="24"
...
const PlusIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="12"
...
const MenuHeartIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="12"
...
const MenuDownloadIcon = ({ size }: IconBasicProps) => {
  return (
...
const BackdIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="22"
...
const NextdIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="22"
...
const DirIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="16"
...
const ExternalIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="16"
...
const TopSearchIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="24"
...
const PlayIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="24"
...
const PauseIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="24"
...
const PlayerPrevIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="16"
...
const PlayerNextIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="16"
...
const ShuffleIcon = ({ size }: IconBasicProps) => {
  return (
...
const RepeatIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="16"
...
const WishlistIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="16"
...
const ScreenIcon = ({ size }: IconBasicProps) => {
  return (
...
const MicIcon = ({ size }: IconBasicProps) => {
  return (
    <svg role="img" height="16" width="16" viewBox="0 0 16 16">
      <path
...
const AddListIcon = ({ size }: IconBasicProps) => {
  return (
    <svg role="img" height="16" width="16" viewBox="0 0 16 16">
      <path
...
const DeviceIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="img"
      height="16"
...
const SoundFullIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="presentation"
      height="16"
...
const SoundMidIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="presentation"
      height="16"
...
const SoundLowIcon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="presentation"
      height="16"
...
const FullScreenicon = ({ size }: IconBasicProps) => {
  return (
    <svg role="img" height="16" width="16" viewBox="0 0 16 16">
      <path
...
const SoundMuteicon = ({ size }: IconBasicProps) => {
  return (
    <svg
      role="presentation"
      height="16"
...
const PlayerPlayIcon = ({ size }: IconBasicProps) => {
  return (
    <svg role="img" height="20" width="20" viewBox="0 0 24 24">
      <path
        d="M7.05 3.606l13.49 7.788a.7.7 0 010 1.212L7.05 20.394A.7.7 0 016 19.788V4.212a.7.7 0 011.05-.606z"
...
const PlayerPauseIcon = ({ size }: IconBasicProps) => {
  return (
    <svg role="img" height="20" width="20" viewBox="0 0 24 24">
      <path
        d="M5.7 3a.7.7 0 00-.7.7v16.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V3.7a.7.7 0 00-.7-.7H5.7zm10 0a.7.7 0 00-.7.7v16.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V3.7a.7.7 0 00-.7-.7h-2.6z"
...
const Icon = ({name, size = 24}: IconIProps) => {
    const icons = {
        home : HomeIcon,
        search: SearchIcon,
        lib: LibIcon,
